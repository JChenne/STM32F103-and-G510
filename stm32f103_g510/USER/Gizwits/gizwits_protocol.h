...
* @{
*/
#define PRODUCT_KEY "a2f8cd23398742dda062707e376db0b6"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "14119e277de04e06b4e15bacdac4a049"
...
* @{
*/
#define choose_1_LEN                           1
#define choose_2_LEN                           1
#define switch_LEN                           1
#define pressure_LEN                           1
#define card_LEN                           1
...
typedef struct {
  ...
  bool valuepressure;
  bool valuecard;
  uint8_t valueGPRS[50];
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
  uint8_t flagchoose_1:1;
  uint8_t flagchoose_2:1;
  uint8_t flagswitch:1;
  uint8_t flagpressure:1;
  uint8_t flagcard:1;
  uint8_t flagGPRS:1;
} dataPointFlags_t;
