...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
  ...
  for(i=0; i<info->num; i++)
  {
    ...
    {
      case EVENT_choose_1:
        currentDataPoint.valuechoose_1 = dataPointPtr->valuechoose_1;
        //GIZWITS_LOG("Evt: EVENT_choose_1 %d \n", currentDataPoint.valuechoose_1);
        if(0x01 == currentDataPoint.valuechoose_1)
        {
          //user handle
        }
        else
        ...
        break;
      case EVENT_choose_2:
        currentDataPoint.valuechoose_2 = dataPointPtr->valuechoose_2;
        GIZWITS_LOG("Evt: EVENT_choose_2 %d \n", currentDataPoint.valuechoose_2);
        if(0x01 == currentDataPoint.valuechoose_2)
        {
          //user handle
        }
        else
